...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        function getUpdate() {
            //request = new ActiveXObject("Microsoft.XMLHTTP");
            //connect the sever and the client side
            request =new XMLHttpRequest();
        ...
        // 200= no error ,request.responseText not empty
        ...
        function updateChat(xmlDoc) {
            ...
            for(var i=0 ; i< messages.length ; i++){
            	...
            	//var imgURL = messages[i].getAttribute("img");
             ...
             var curr_index =0;
                while (curr_index != -1){
                    ...
                    if (index_of_http == -1) {
                        ...
                        if (index_of_space == -1){
                            url_str =  contentStr.substring(index_of_http); // until the end
                        }else{
    ...
    <div id="svg_div" style= "overflow-y:scroll; height:340px; width:540px; overflow-x:hidden">
