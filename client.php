            ...
            <table border="0" cellspacing="5" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                    	...
                    	<button style="background-color:red;width:30px;height:30px" onclick="select_color('red'); return false"/>
                    	<button style="background-color:blue;width:30px;height:30px" onclick="select_color('blue'); return false"/>
                    </td>
                </tr>
